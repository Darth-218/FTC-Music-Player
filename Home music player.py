...
frame_2 = customtkinter.CTkFrame(frame_1,corner_radius=20)
frame_2.pack(side="right", fill="both", expand=True, padx=(150,420), pady=(40,95))

frame_3 = customtkinter.CTkFrame(frame_1,width=120, height=200, corner_radius=20)
frame_3.place(relx=0.0135, rely=0.045)

frame_4 = customtkinter.CTkFrame(frame_1, width=120, height=555, corner_radius=20)
...
frame_6 = customtkinter.CTkFrame(frame_1,width=360, height=760, corner_radius=20)
frame_6.place(relx=0.715, rely=0.045)

# Link input
link = customtkinter.CTkEntry(frame_2, width=350, height=40, font=("Systemia",15), fg_color="gray10", border_color="white", border_width=0.5, text_color="grey", corner_radius=50)
