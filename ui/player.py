...
class Player(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.profile_name = customtkinter.CTkLabel(self.profile_card, text='selected_song.artist', font=('Systemia', 15, 'bold'), text_color='gray')
        ...
        self.slider.grid(row=0, column=0, columnspan=2, sticky='nsew', padx=20, pady=5)
        self.position = customtkinter.CTkLabel(self.timeFrame, text='00:00', font=('Systemia', 10))
        self.position.grid(row=1, column=0, sticky='w', padx=20, pady=0)
        self.duration = customtkinter.CTkLabel(self.timeFrame, text='00:00', font=('Systemia', 10))
